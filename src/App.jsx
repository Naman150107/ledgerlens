  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-canvas-soft text-ink relative pb-16">
      ...
      <header className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-6">
        <div className="bg-white/80 backdrop-blur-md border border-hairline rounded-xl px-6 py-4 flex items-center justify-between shadow-[rgba(0,55,112,0.06)_0px_8px_24px]">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setActiveTab("home")}>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-primary to-primary-soft flex items-center justify-center text-white shadow-[0_4px_12px_rgba(83,58,253,0.25)] border border-white/10">
            ...
            <div>
              <h1 className="text-xl font-semibold tracking-tight text-ink select-none">
                Ledger<span className="text-primary font-light">Lens</span>
              </h1>
              <p className="text-[10px] text-ink-mute uppercase tracking-widest font-semibold">
          ...
          {activeTab === "home" ? (
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              <button 
                ...
                className="text-xs font-semibold text-ink-secondary hover:text-primary transition cursor-pointer"
              >
                Features
              </button>
              <button 
              ...
              <button 
                onClick={() => { setActiveTab("dashboard"); loadData(); }} 
                className="px-4 py-2 bg-primary hover:bg-primary-deep text-white text-xs font-semibold rounded-pill shadow-sm transition transform hover:-translate-y-0.5 duration-150 cursor-pointer"
              >
                Open Dashboard
              </button>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {/* View Tabs */}
              <div className="flex bg-canvas-soft p-1 rounded-pill border border-hairline">
                <button 
                  onClick={() => { setActiveTab("dashboard"); loadData(); }}
                  className={`flex items-center gap-1.5 px-4 py-1.5 rounded-pill text-sm transition-all duration-200 font-medium cursor-pointer ${
                    activeTab === "dashboard" 
        ...
        {activeTab === "home" && (
          <div className="space-y-20 pb-20 animate-fadeIn select-none">
            ...
            <div className="text-center max-w-3xl mx-auto pt-16 sm:pt-24 space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl font-light tracking-tight text-ink leading-tight">
                Handwritten ledgers,<br />
                <span className="font-normal text-primary">digitized in seconds.</span>
              </h2>
              <p className="text-base sm:text-lg text-ink-secondary max-w-xl mx-auto leading-relaxed font-sans">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                <button 
                  onClick={() => { setActiveTab("dashboard"); loadData(); }}
                  className="px-8 py-3 bg-primary hover:bg-primary-deep text-white font-medium rounded-pill shadow-lg shadow-primary/20 hover:shadow-primary/30 transform hover:-translate-y-0.5 transition duration-200 text-sm flex items-center gap-2 group cursor-pointer"
                >
                  Open Dashboard
                ...
                <button 
                  onClick={() => setActiveTab("scan")}
                  className="px-8 py-3 bg-white hover:bg-canvas-soft text-primary font-medium rounded-pill border border-hairline hover:border-primary/30 shadow-sm transform hover:-translate-y-0.5 transition duration-200 text-sm flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="max-w-5xl mx-auto relative rounded-2xl overflow-hidden border border-hairline shadow-2xl bg-white p-2">
              <div className="bg-canvas-soft border border-hairline rounded-xl p-4 sm:p-6 space-y-6">
                ...
                <div className="flex items-center justify-between border-b border-hairline pb-4">
                  ...
                  <span className="text-xs text-ink-mute font-medium bg-white px-3 py-1 rounded-md border border-hairline">ledgerlens.app/dashboard</span>
            ...
            <div className="bg-canvas-cream border border-hairline/60 rounded-2xl p-8 max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
              ...
              <button 
                onClick={() => setActiveTab("scan")}
                className="px-6 py-2.5 bg-ink hover:bg-brand-dark text-white text-xs font-semibold rounded-pill shadow-lg transition flex items-center gap-1.5 shrink-0 cursor-pointer"
              >
                Start Scanning Now
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-brand-dark text-white rounded-xl p-6 shadow-lg relative overflow-hidden border border-brand-dark-900">
                ...
                <h3 className="text-4xl font-light tracking-tight tnum">
              ...
              <div className="bg-white rounded-xl p-6 border border-hairline shadow-sm relative overflow-hidden">
                ...
                <h3 className="text-4xl font-light tracking-tight text-ink tnum">
                  {uniqueCustomers}
                </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 bg-white rounded-xl p-6 border border-hairline shadow-sm flex flex-col min-h-[380px]">
                <div className="mb-4">
                  ...
                  {chartData.length > 0 ? (
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <XAxis type="number" stroke="#64748d" fontSize={11} tickFormatter={(v) => `₹${v}`} />
                        <YAxis dataKey="name" type="category" stroke="#64748d" fontSize={11} width={80} />
                        <Tooltip 
                          formatter={(v) => [`₹${v}`, "Outstanding"]}
                          contentStyle={{ background: "#0d253d", color: "#fff", borderRadius: "8px", fontSize: "12px" }}
                        />
                        <Bar dataKey="amount" radius={[0, 99, 99, 0]} barSize={16}>
                            ...
                            <td className="px-4 py-3.5">
                              <div className="flex items-center justify-center gap-1.5">
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-full hover:bg-emerald-50 text-emerald-600 hover:text-emerald-700 transition"
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-full hover:bg-primary-subdued/30 text-primary hover:text-primary-deep transition"
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-full hover:bg-ruby/10 text-ruby hover:text-ruby transition"
                                  title="Delete Record"
                                >
                            ...
                            >
                              ...
                              <td className="px-3 py-2 text-center">
                                <button
                                  ...
                                  className="text-ink-mute hover:text-ruby p-1 rounded hover:bg-canvas-soft"
                                >
                                  <Trash2 className="w-4 h-4" />
                                </button>
                              </td>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-md overflow-hidden shadow-2xl border border-hairline animate-zoomIn">
            ...
            <div className="p-4 bg-canvas-soft border-t border-hairline flex justify-end gap-3">
              <button
                onClick={() => setWhatsappModal({ open: false, entry: null, phone: "" })}
                className="px-4 py-2 border border-hairline rounded-pill text-sm font-medium hover:bg-white transition text-ink-secondary"
              >
                Cancel
              </button>
              <a
                ...
                onClick={() => setWhatsappModal({ open: false, entry: null, phone: "" })}
                className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-pill text-sm font-medium shadow transition flex items-center gap-1.5"
              >
                Send on WhatsApp
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-md overflow-hidden shadow-2xl border border-hairline animate-zoomIn">
            ...
            <div className="p-4 bg-canvas-soft border-t border-hairline flex justify-end">
              <button
                onClick={() => setUpiModal({ open: false, entry: null, upiId: "merchant@upi" })}
                className="px-6 py-2 bg-primary hover:bg-primary-deep text-white rounded-pill text-sm font-medium shadow transition"
              >
                Done
              </button>
            </div>
